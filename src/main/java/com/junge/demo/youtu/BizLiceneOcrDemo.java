...
public class BizLiceneOcrDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			response = faceYoutu
					.BizLicenseOcrImgStr(com.junge.demo.youtu.ImgFileUtil2.getImageStr("E://三证合一营业执照.jpg"));
			System.out.println(response);
			
			/*response = faceYoutu.BizLicenseOcr("E://三证合一营业执照.jpg");
			// get respose
			System.out.println(response);*/
